...
namespace GamesRental.Data.Migrations
{
    ...
    [Migration("20260417063552_AddedCommentsForDataModels")]
    partial class AddedCommentsForDataModels
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GamesRental.Data.Models.ApplicationUser", b =>
                {
                    ...
                    b.ToTable("AspNetUsers", null, t =>
                        {
                            t.HasComment("Application user account");
                        });
                });
            ...
            modelBuilder.Entity("GamesRental.Data.Models.Game", b =>
                {
                    ...
                    b.Property<int>("GenreId")
                        .HasColumnType("int")
                        .HasComment("Related genre identifier");

                    b.Property<string>("ImageUrl")
                        .IsRequired()
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)")
                        .HasComment("Game cover image URL");

                    b.Property<int>("PlatformId")
                        .HasColumnType("int")
                        .HasComment("Related platform identifier");
                    ...
                    b.Property<int>("TotalCopies")
                        .HasColumnType("int")
                        .HasComment("Total number of copies for the game");
                    ...
                    b.ToTable("Games", t =>
                        {
                            t.HasComment("Game available for rental");
                        });
            ...
            modelBuilder.Entity("GamesRental.Data.Models.GameCopy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("Game copy identifier");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id"));

                    b.Property<int>("GameId")
                        .HasColumnType("int")
                        .HasComment("Related game identifier");

                    b.Property<bool>("IsRented")
                        .HasColumnType("bit")
                        .HasComment("Whether the copy is currently rented");

                    b.Property<string>("RentedByUserId")
                        .HasColumnType("nvarchar(450)")
                        .HasComment("Identifier of the user currently renting the copy");

                    b.Property<DateTime?>("RentedOn")
                        .HasColumnType("datetime2")
                        .HasComment("Date and time when the copy was rented");
                    ...
                    b.ToTable("GameCopies", t =>
                        {
                            t.HasComment("Individual rentable copy of a game");
                        });
            ...
            modelBuilder.Entity("GamesRental.Data.Models.Rental", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("Rental identifier");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id"));

                    b.Property<int>("GameCopyId")
                        .HasColumnType("int")
                        .HasComment("Related game copy identifier");

                    b.Property<DateTime>("RentedOn")
                        .HasColumnType("datetime2")
                        .HasComment("Date and time when the game copy was rented");

                    b.Property<DateTime?>("ReturnedOn")
                        .HasColumnType("datetime2")
                        .HasComment("Date and time when the game copy was returned");

                    b.Property<string>("UserId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)")
                        .HasComment("Identifier of the user who rented the game copy");
                    ...
                    b.ToTable("Rentals", t =>
                        {
                            t.HasComment("Rental transaction");
                        });
                });
            ...
            modelBuilder.Entity("GamesRental.Data.Models.Review", b =>
                {
                    ...
                    b.Property<string>("Comment")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)")
                        .HasComment("Review comment text");
                    ...
                    b.Property<int>("Rating")
                        .HasColumnType("int")
                        .HasComment("Review rating value");
                    ...
                    b.ToTable("Reviews", t =>
                        {
                            t.HasComment("User review for a game");
                        });
                });
            ...
            modelBuilder.Entity("GamesRental.Data.Models.Wishlist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("Wishlist entry identifier");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("Id"));

                    b.Property<DateTime>("AddedOn")
                        .HasColumnType("datetime2")
                        .HasComment("Date and time when the game was added to the wishlist");

                    b.Property<int>("GameId")
                        .HasColumnType("int")
                        .HasComment("Identifier of the wished game");

                    b.Property<string>("UserId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)")
                        .HasComment("Identifier of the user who added the game to the wishlist");
